package com.farroos.myworkmanager
...
import com.farroos.myworkmanager.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), OnClickListener {
    ...
    override fun onClick(v: View) {
        when(v.id){
            ...
            R.id.btnCancelTask -> startCancelTask()
        }
    }
